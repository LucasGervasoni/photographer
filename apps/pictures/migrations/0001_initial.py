# Generated by Django 5.0.7 on 2024-08-25 15:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by_view', models.CharField(blank=True, max_length=100, null=True)),
                ('zip_file_path', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.FileField(max_length=255, upload_to=apps.pictures.models.order_image_path)),
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('photos_sent', models.CharField(max_length=150, verbose_name='Assets to be uploaded')),
                ('photos_returned', models.CharField(default='0', max_length=150, verbose_name='Assets to be returned')),
