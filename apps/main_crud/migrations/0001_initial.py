    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Not Uploaded', 'Not Uploaded'), ('Uploaded', 'Uploaded'), ('Production', 'Production'), ('Completed', 'Completed')], default='Not Uploaded', max_length=150, verbose_name='Status')),
            ],
        ),
        migrations.CreateModel(
