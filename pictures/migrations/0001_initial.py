    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('services', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('Drone', 'Drone'), ('Photo', 'Photo'), ('3d scan', '3d scan'), ('Vídeo', 'Vídeo'), ('Floor Plan', 'Floor Plan')], max_length=36)),
